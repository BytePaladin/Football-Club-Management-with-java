...
public class Manager extends Person implements View, Update, Announcements {
    ...
    public static void SignInNewPlayers() throws IOException {
        ...
        try (BufferedWriter writeNewPlayer = new BufferedWriter(new FileWriter("C:\\Users\\USER\\eclipse-workspace\\FootballDraft\\Files\\Player.txt", true))) {
    ...
    public static void SignInNewCoachs() throws IOException {
        ...
        // Use try-with-resources to ensure BufferedWriter is closed properly
        try (BufferedWriter writeNewCoach = new BufferedWriter(new FileWriter("C:\\Users\\USER\\eclipse-workspace\\FootballDraft\\Files\\Coach.txt", true))) {
    ...
    public static void TerminateContractPlayer() throws IOException {
        ...
        File inputFile = new File("C:\\Users\\USER\\eclipse-workspace\\FootballDraft\\Files\\Player.txt");
    ...
    public static void TerminateContractCoach() throws IOException {
        ...
        File inputFile = new File("C:\\Users\\USER\\eclipse-workspace\\FootballDraft\\Files\\Coach.txt");
    ...
    public void viewPlayer() {
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\USER\\eclipse-workspace\\FootballDraft\\Files\\Player.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
    ...
    public void playerAnnouncements() {
        ...
        // Use try-with-resources to ensure BufferedWriter is closed properly
        try (BufferedWriter writeAnnouncement = new BufferedWriter(new FileWriter("C:\\Users\\USER\\eclipse-workspace\\FootballDraft\\Files\\PlayerAnnouncements.txt", true))) {
    ...
    public void coachAnnouncements() {
        ...
        // Use try-with-resources to ensure BufferedWriter is closed properly
        try (BufferedWriter writeAnnouncement = new BufferedWriter(new FileWriter("C:\\Users\\USER\\eclipse-workspace\\FootballDraft\\Files\\CoachAnnouncements.txt", true))) {
            writeAnnouncement.write("Announcement: " + announcement);
            writeAnnouncement.newLine();
            writeAnnouncement.write("Date and Time of Announcement: " + dateTimeOfAnnouncement.format(formatter));
            writeAnnouncement.newLine();
